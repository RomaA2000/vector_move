...
typedef std::vector<counted> container_std;
typedef vector<int> container_int;
template<typename T>
void cout_vector(vector<T> const &in) {
...
TEST(correctness, move_ctor_empty)
{
  faulty_run([]
  {
    counted::no_new_instances_guard g;
...
TEST(correctness, big_assignment)
{
  faulty_run([]
  {
...
TEST(correctness, big_move_assignment)
{
  faulty_run([]
  {
    const size_t TEST_SIZE = 100;
...
TEST(correctness, move_assignment_empty)
{
  faulty_run([]
  {
    counted::no_new_instances_guard g;
...
TEST(correctness, move_assignment_empty_2)
{
  faulty_run([]
  {
    counted::no_new_instances_guard g;
...
TEST(correctness, move_assignment_self_empty)
{
  faulty_run([]
  {
    counted::no_new_instances_guard g;
...
TEST(correctness, move_const_subscript)
{
  faulty_run([]
  {
    counted::no_new_instances_guard g;
...
//}
//
//TEST(correctness, constr)
//{
//vector<int> c;
//for ( size_t i = 0; i != 10; ++i) {
//c.push_back(42);
//}
//vector<int> b(c.begin(), c.end());
//}
//
